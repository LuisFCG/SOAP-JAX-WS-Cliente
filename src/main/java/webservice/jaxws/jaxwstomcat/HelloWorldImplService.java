 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://JAXWSTOMCAT.jaxws.webservice/", wsdlLocation = "http://localhost:8043/JAX-WS-TOMCAT/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://JAXWSTOMCAT.jaxws.webservice/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8043/JAX-WS-TOMCAT/hello?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://JAXWSTOMCAT.jaxws.webservice/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://JAXWSTOMCAT.jaxws.webservice/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
