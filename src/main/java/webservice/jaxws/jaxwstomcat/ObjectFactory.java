 ...
 * generated in the webservice.jaxws.jaxwstomcat package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorldResponse_QNAME = new QName("http://JAXWSTOMCAT.jaxws.webservice/", "helloWorldResponse");
    private final static QName _HelloWorld_QNAME = new QName("http://JAXWSTOMCAT.jaxws.webservice/", "helloWorld");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: webservice.jaxws.jaxwstomcat
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://JAXWSTOMCAT.jaxws.webservice/", name = "helloWorldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://JAXWSTOMCAT.jaxws.webservice/", name = "helloWorld")
